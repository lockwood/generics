...
<head>
	...
	<title>Esekey Generics: Quick and Easy Web content and more</title>
	...
	<!-- Include jQuery UI Stuff Here -->
	<link href="css/themes/<?=$theme?>/jquery-ui.css" rel="stylesheet">
...
foreach ($section as $id=>$sectionarray) {
	if (isset($sectionarray['menu'])) {
		if (count($sectionarray['menu']) > 1) {
			...
			echo '
		<li class="menu-2'.$active.'"><a class="parent">'.$sectionarray['name'].' <img src="/images/icon-drop.png" width="9" height="5" alt=" " /></a>
			<ul>
					<li><a href="/'.$sectionarray['menu'][0]['page_name'].'"><i class="icon-chevron-sign-right"></i>  '.ucfirst(str_replace('-',' ',$sectionarray['menu'][0]['page_name'])).'</a></li>
';
			for ($i=1;$i<count($sectionarray['menu']);$i++) {
				echo '
					<li><a href="/'.$sectionarray['menu'][$i]['page_name'].'"><i class="icon-chevron-sign-right"></i>  '.ucfirst(str_replace('-',' ',$sectionarray['menu'][$i]['page_name'])).'</a></li>
';
			}
			echo '
			</ul>
...
';
			...
			echo '
		<li class="menu-4'.$active.'"><a class="parent" href="/'.$seg.'">'.ucfirst(str_replace('-',' ',$sectionarray['menu'][0]['page_name'])).'</a>
		</li>
';
		}
	}
...
<!-- 
	...
	<ul id="menu">
		...
		<li>
			...
			foreach ($themes as $theme_opt) {
				echo '
				<li><a href="/welcome/index/'.$theme_opt.'/">'.$theme_opt.'</a></li>';
			}
			?>
			</ul>
		</li>
	...
	<div id="dialog" title="I am a Dialog Box">
	...
	<div id="accordion">
	  ...
	  <h3>Advance jQuery Techniques</h3>
	  <div>
		<p>
...
<p>Powered by <a href="#">CodeIgniter</a> and <a href="#">JQuery</a></p>
